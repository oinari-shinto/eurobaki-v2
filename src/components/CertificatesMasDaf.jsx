...
const CertificatesMasDaf = () => {
    ...
    return (
        <CertificatesContainer>
            <TopLine >Сертификаты MasDaf</TopLine>
            <Description >Сертификаты на расширительные баки MasDaf</Description>
